...
--Agregamos las disponibilidades de las reservas
SET IDENTITY_INSERT Estados_Reservas  ON;
INSERT INTO Estados_Reservas (id, descripcion_estado_reserva)
VALUES(1,'Confirmada'),(2,'Cancelada')
SET IDENTITY_INSERT Estados_Reservas OFF;

--Agregamos la disponibilidad de las categorias
SET IDENTITY_INSERT Disponibilidad_Categorias  ON;
INSERT INTO Disponibilidad_Categorias (id,fecha,cantidad_disponible,categoria_id)
VALUES 
(1,'2025-06-22',2,1),(2,'2025-07-21',2,2),(3,'2025-08-24',4,3),(4,'2026-04-20',1,4),(5,'2025-10-22 ',8,5),
(6,'2025-11-22',3,6),(7,'2025-12-15',5,7),(8,'2025-06-25',7,8),(9,'2025-07-25',1,9) 
SET IDENTITY_INSERT Disponibilidad_Categorias OFF;

--Caso de prueba: 
--Hotel Mar Azul, Mar del Plata
--fecha de ingreso 28/08/25 a fecha de salida 31/08/25 
--4 personas 2 habitaciones
--Resultado: habitaciones disponibles  
--2 triples,1 triple y 1 doble,2 dobles
--2 Estandar triple: 240.000 +50.400 (iva) + 12.000 (cargos) total = 302.400
--estandar triple y suite doble: 255.000 + 53.550(iva) + 12.750 (cargos)=321.300
--2 suite doble: 270.000+ 56.700 (iva) + 13.500 (cargos) = 340.200
